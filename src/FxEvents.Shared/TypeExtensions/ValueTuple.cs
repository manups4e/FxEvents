...
// if serverside is using .Net Standard 2.0 ValueTuple is already included, if serverside is using .net framekwork.. what are you waiting for?? convert to .Net Standard 2.0
#if CLIENT
